      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto text-center mb-10">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-slate-200/90 text-slate-800 text-xs font-bold shadow-xs mb-5 font-['Space_Grotesk']">
            ...
            <span>Sino Gate 華門國際</span>
            <span className="text-slate-300">|</span>
            <span className="text-blue-700 font-semibold">Shenzhen & Hong Kong Operations</span>
          </div>
          ...
          <p className="mt-5 text-base sm:text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
            Direct carrier contracts from major China ports, verified factory procurement, 18-hour ISO quality inspections, and fast-track company formation in Mainland China & Hong Kong.
          </p>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-2 sm:gap-4 text-xs font-semibold text-slate-700">
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-slate-200/80 shadow-2xs">
              ...
              <span>NVOCC Licensed Freight</span>
            </div>
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-slate-200/80 shadow-2xs">
              <ShieldCheck className="w-3.5 h-3.5 text-emerald-600" />
              <span>ISO 2859-1 (AQL II) Inspections</span>
            </div>
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-slate-200/80 shadow-2xs">
              <Building2 className="w-3.5 h-3.5 text-indigo-600" />
              <span>China WFOE & HK Setup</span>
            </div>
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-slate-200/80 shadow-2xs">
              <Clock className="w-3.5 h-3.5 text-amber-600" />
              <span>1-Hour RFQ Response</span>
            </div>
          </div>
