        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-slate-100">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight font-['Space_Grotesk']">
              Find your trade route & freight index
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 pt-6">
          ...
          <div className="xl:col-span-8 flex flex-col justify-between space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative">
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider block">
                    From (China Export Port / Hub)
                  </label>
                  <div className="relative">
                    <select
                      value={originId}
                      onChange={(e) => setOriginId(e.target.value)}
                      className="w-full bg-white text-slate-900 font-bold text-base sm:text-lg rounded-xl px-3.5 py-3 border border-slate-200 shadow-xs focus:ring-2 focus:ring-blue-500 focus:outline-hidden appearance-none cursor-pointer pr-10"
                    >
                      {ORIGIN_PORTS.map((p) => (
                  ...
                  <p className="text-[11px] text-slate-500 font-medium pl-1">
                    {origin.name} • Local Sino Gate office on-site
                  </p>
                </div>
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider block">
                    To (Global Destination Port / City)
                  </label>
                  <div className="relative">
                    <select
                      value={destId}
                  ...
                  <p className="text-[11px] text-slate-500 font-medium pl-1">
                    {dest.city}, {dest.country} • Customs clearance & DDP door delivery available
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              ...
              <div className="bg-[#F8FAFC] p-3.5 rounded-2xl border border-slate-200/80 flex items-center gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="text-xs sm:text-sm font-bold text-slate-800 bg-transparent border-0 focus:outline-hidden p-0 cursor-pointer"
                  />
                </div>
              </div>
              ...
              <div className="bg-[#F8FAFC] p-3.5 rounded-2xl border border-slate-200/80 flex items-center gap-3 sm:col-span-2 md:col-span-1">
                ...
                <div className="w-full">
                  ...
                  >
                    <option value="40HQ">40' High Cube Container (76 CBM)</option>
                    <option value="20GP">20' General Container (33 CBM)</option>
                    <option value="40GP">40' General Container (67 CBM)</option>
                    <option value="LCL_5CBM">LCL Palletized (1-10 CBM)</option>
                    <option value="AIR_500KG">Air Freight (&gt;500 kg)</option>
                  </select>
                </div>
              </div>
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <div className="flex-1 flex flex-col items-center justify-center px-4 w-full">
                  <div className="flex items-center gap-2 text-[11px] font-bold text-blue-700 mb-1">
                    ...
                    <span>Direct Maritime & Intermodal Corridor</span>
                  </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-900 leading-tight">
                    Bilingual China Ops Team
                  </p>
                  <p className="text-[11px] text-slate-500">
                    On-dock supervisors in Yantian, Ningbo & HK
                  </p>
                </div>
              </div>
              ...
              >
                <span>Lock In Freight Rate & Space</span>
                <span className="font-normal text-blue-200 group-hover:translate-x-1 transition-transform">›››</span>
              </button>
            ...
            <div className="bg-[#141722] text-white rounded-3xl p-5 shadow-lg border border-slate-800">
              ...
              <div className="grid grid-cols-3 gap-2 py-3 border-t border-slate-800/60 text-center">
                <div>
                  ...
                  <span className="text-xs font-bold text-white">
                    {activePortStatus.avgBerthWaitHours} hrs
                  </span>
                </div>
                <div>
                  <div className="flex items-center justify-center gap-1 text-[11px] text-slate-400 mb-0.5">
                  ...
                  <span className="text-xs font-bold text-white">
                    {activePortStatus.customsDwellHours} hrs
                  </span>
                </div>
                <div>
                  <div className="flex items-center justify-center gap-1 text-[11px] text-slate-400 mb-0.5">
                  ...
                  <span className="text-xs font-bold text-white">
                    {activePortStatus.weeklySailings}/wk
                  </span>
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-slate-800/80">
                <div className="flex items-center justify-between text-xs mb-2">
                  <span className="text-slate-300 font-medium">Weekly Throughput Index</span>
                  <span className="text-emerald-400 font-bold text-[11px]">Normal Flow</span>
                </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">
                    Dual legal entity in Shenzhen & Hong Kong
                  </p>
                </div>
              </div>
