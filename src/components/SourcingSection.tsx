      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-xs font-bold mb-4 font-['Space_Grotesk']">
            <span>Direct Sourcing in China</span>
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight font-['Space_Grotesk']">
            Your trusted procurement team on the ground in China
          </h2>
          <p className="mt-4 text-base sm:text-lg text-slate-600 leading-relaxed">
            Stop buying from English-speaking trading companies posing as factories. We audit direct manufacturers in Guangdong, Zhejiang, and Jiangsu, negotiate at domestic RMB rates, and draft enforceable Chinese-law contracts.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 mb-10 pb-4 border-b border-slate-100">
          ...
          >
            Direct Factory vs. Alibaba Trading Broker
          </button>
          <button
          ...
          >
            Sample Consolidation Hub (Save 65%+)
          </button>
        </div>
            ...
            {SOURCING_STEPS.map((step, idx) => (
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t border-slate-200/60 flex items-center justify-between text-xs font-semibold text-blue-700">
                  <span>Verified by Sino Gate</span>
            ...
            <div className="bg-[#141722] text-white rounded-3xl p-7 flex flex-col justify-between shadow-md">
              <div>
                <span className="text-xs font-bold text-blue-400 uppercase tracking-wider block mb-2">
                  Have product drawings or a spec sheet?
                </span>
                <h3 className="text-xl font-extrabold font-['Space_Grotesk'] mb-3">
                  Get 3 audited factory quotes in 48 hours
                </h3>
                <p className="text-xs text-slate-300 leading-relaxed">
                  Send us your target FOB price, BOM, or Alibaba link. Our bilingual sourcing managers will physically verify true manufacturers and return domestic quotation sheets.
                </p>
              </div>
              <button
          ...
          <div className="bg-[#F8FAFC] rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-xs">
            <div className="text-center max-w-2xl mx-auto mb-8">
              <h3 className="text-xl sm:text-2xl font-extrabold text-slate-900 font-['Space_Grotesk']">
                The Reality of Buying from China Online
              </h3>
              <p className="text-sm text-slate-600 mt-2">
                Over 65% of vendors on online wholesale platforms are 2nd or 3rd-tier trading companies with markup layers and zero quality control. Here is how Sino Gate protects your capital:
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-rose-200 shadow-xs">
                <div className="flex items-center gap-2.5 text-rose-700 font-bold mb-4 pb-3 border-b border-rose-100">
                  ...
                  <span className="text-base font-['Space_Grotesk']">Online Trading Agents / Brokers</span>
                </div>
                <ul className="space-y-3.5 text-xs text-slate-700">
                  <li className="flex items-start gap-2">
                    <span className="text-rose-500 font-bold">✕</span>
                    <span><strong>15% - 35% Hidden Markup:</strong> Middlemen add undisclosed margins while hiding the true factory name and location.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-rose-500 font-bold">✕</span>
                    <span><strong>No Legal Recourse:</strong> Foreign disputes cannot be settled through overseas courts once money is wired to offshore accounts.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-rose-500 font-bold">✕</span>
                    <span><strong>Subcontracting Bait-and-Switch:</strong> Perfect gold sample supplied initially; bulk order secretly outsourced to an inferior cheap workshop.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-rose-500 font-bold">✕</span>
                    <span><strong>No Intellectual Property Protection:</strong> Your tooling and CAD mold designs are sold freely to your competitors on domestic marketplaces.</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-blue-300 shadow-sm relative overflow-hidden">
                ...
                <div className="flex items-center gap-2.5 text-blue-700 font-bold mb-4 pb-3 border-b border-blue-100">
                  ...
                  <span className="text-base font-['Space_Grotesk']">Sino Gate Boots-on-the-Ground Partner</span>
                </div>
                <ul className="space-y-3.5 text-xs text-slate-700">
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-600 font-bold">✓</span>
                    <span><strong>Direct Factory Transparency:</strong> You receive the actual factory name, business registration code, address, and owner contact.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-600 font-bold">✓</span>
                    <span><strong>Enforceable NNN Agreements:</strong> Drafted in Chinese under PRC jurisdiction, legally binding in local Chinese people's courts.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-600 font-bold">✓</span>
                    <span><strong>Domestic Price Discovery:</strong> Quotes benchmarked against domestic factory wholesale indices in RMB with transparent cost breakdowns.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-600 font-bold">✓</span>
                    <span><strong>Milestone Escrow:</strong> Final supplier payment is released only after our independent inspector signs off on the AQL inspection.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 space-y-4">
                <div className="flex items-center gap-2 text-blue-700 font-bold text-xs uppercase tracking-wider">
                  ...
                  <span>Shenzhen & Yiwu Bonded Consolidation Hub</span>
                </div>
                <h3 className="text-2xl font-extrabold text-slate-900 font-['Space_Grotesk']">
                  Consolidate Multiple Factory Samples into One Courier Shipment
                </h3>
                <p className="text-sm text-slate-600 leading-relaxed">
                  Instead of paying $100–$150 DHL courier fees to 4 or 5 different factories across China, instruct them to ship domestic freight ($3 to $5) to our Shenzhen or Yiwu fulfillment centers.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  <div className="p-3 bg-white rounded-xl border border-slate-200 text-xs">
                    <span className="font-bold text-slate-900 block mb-1">Unboxing & Photo Bench Check</span>
                    <span className="text-slate-500">We inspect prototypes upon arrival, measure dimensions, and take HD photos before forwarding.</span>
                  </div>
                  <div className="p-3 bg-white rounded-xl border border-slate-200 text-xs">
                    <span className="font-bold text-slate-900 block mb-1">Repackaging & Space Optimization</span>
                    <span className="text-slate-500">We remove unnecessary bulky factory packaging to minimize volumetric weight billing.</span>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 bg-white rounded-2xl p-6 border border-slate-300 shadow-md">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex justify-between text-[11px] text-slate-400 mt-1">
                    <span>2 Factories</span>
                    <span>5 Factories</span>
                    <span>8 Factories</span>
                  </div>
                </div>

                <div className="space-y-2 py-3 border-y border-slate-100 text-xs">
                  <div className="flex justify-between text-slate-600">
                    <span>Individual Express (Direct from each):</span>
                    <span className="font-bold text-slate-800 line-through">${directShippingCost} USD</span>
                  </div>
                  <div className="flex justify-between text-blue-700 font-bold">
                    <span>Sino Gate Consolidated Express:</span>
                ...
                <div className="mt-4 p-3 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center justify-between">
                  <div>
                    <span className="text-[11px] font-bold text-emerald-800 uppercase block">Estimated Savings</span>
